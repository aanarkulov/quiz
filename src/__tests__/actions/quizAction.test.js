...
describe('quiz actions', () => {
  ...
  it('fetchQuizes test', async () => {
    ...
    mockAxios.get.mockImplementationOnce(() => Promise.resolve({ data: quizes }));
  ...
  it('fetchQuizById test', async () => {
    ...
    mockAxios.get.mockImplementationOnce(() => Promise.resolve({ data: quiz }));
  ...
  describe('quizAnswerClick test', () => {
    ...
    it('if answerState not null', async () => {
      store = mockStore({ quiz: { answerState: { 1: 'success' } } });
